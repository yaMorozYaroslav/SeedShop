...
export const FirstLine = styled.p`margin-top:140px;grid-column: 2/7;
                         ...
                         @media (max-width: 600px) {font-size:35px;margin-top:200px;}
...
export const ItemLink = styled(Link)`grid-column:5/6;grid-row:3;
                        ...
                        @media (max-width: 600px) {margin-top:-100px;}
                        @media (max-width: 400px) {}`
export const SeedLink = styled(Link)`grid-column:3/4;grid-row:3;
                                     margin-top:-80px;font-size:26px;
                        @media (max-width: 600px) {margin-top:-100px;}
                        @media (max-width: 400px) {}`
export const StyledImage = styled(Image)`width:150px;height:150px;
                                         border-style: groove;
